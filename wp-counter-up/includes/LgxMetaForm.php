...
class ClassWPCounterUpMetaForm
{
    ...
    public function bgColorTypo(array $args)
    {
        ...
        $output_safe .= '<div class="lgx_group_field_label">' . $args['label_color'] . '</div>';
        $output_safe .= '<input type="text" value="' . $meta_value_color . '" id="' . $args['id_color'] . '" class="lgx_input_width lgx_app_meta_filed lgx_color_picker" name="' . $args['name_color'] . '" data-default-color="' . $meta_value_color . '" data-alpha-enabled="true" ' . $is_pro_color . '>';
        $output_safe .= $is_pro_label_color;
        $output_safe .= '</div>'; //item 1

        $output_safe .= '<div class="lgx_group_field_item">';
        $output_safe .= '<div class="lgx_group_field_label">' . $args['label_hColor'] . '</div>';
        $output_safe .= '<input type="text" value="' . $meta_value_hColor . '" id="' . $args['id_hColor'] . '" class="lgx_input_width lgx_app_meta_filed lgx_color_picker" name="' . $args['name_hColor'] . '" data-default-color="' . $meta_value_hColor . '" data-alpha-enabled="true" ' . $is_pro_hColor . '>';
        $output_safe .= $is_pro_label_hColor;
    ...
    public function borderTypo(array $args)
    {
        ...
        $output_safe .= '<div class="lgx_group_field_item">';
        $output_safe .= '<div class="lgx_group_field_label">' . $args['label_width'] . '</div>';
        $output_safe .= '<input type="text" value="' . $meta_value_width . '" placeholder="' . $meta_value_width . '"  id="' . $args['id_width'] . '" class="lgx_input_width lgx_app_meta_filed lgx_app_meta_text" name="' . $args['name_width'] . '" ' . $is_pro_width . '>';
        $output_safe .= $is_pro_label_width;
        $output_safe .= '</div>'; //item 2

        $output_safe .= '<div class="lgx_group_field_item">';
        $output_safe .= '<div class="lgx_group_field_label">' . $args['label_radius'] . '</div>';
        $output_safe .= '<input type="text" value="' . $meta_value_radius . '" placeholder="' . $meta_value_radius . '"  id="' . $args['id_radius'] . '" class="lgx_input_radius lgx_app_meta_filed lgx_app_meta_text" name="' . $args['name_radius'] . '" ' . $is_pro_radius . '>';
        $output_safe .= $is_pro_label_radius;
        $output_safe .= '</div>'; //item 3

        $output_safe .= '<div class="lgx_group_field_item">';
        $output_safe .= '<div class="lgx_group_field_label">' . $args['label_hColor'] . '</div>';
        $output_safe .= '<input type="text" value="' . $meta_value_hColor . '" id="' . $args['id_hColor'] . '" class="lgx_input_width lgx_app_meta_filed lgx_color_picker" name="' . $args['name_hColor'] . '" data-default-color="' . $meta_value_hColor . '" data-alpha-enabled="true" ' . $is_pro_hColor . '>';
        $output_safe .= $is_pro_label_hColor;
        $output_safe .= '</div>'; //item 4
    ...
    public function textMulti(array $args)
    {
        ...
        $output_safe .= ((isset($args['id_1']))  ? $item_html_1 : '');
        $output_safe .= ((isset($args['id_2']))  ? $item_html_2 : '');
        $output_safe .= ((isset($args['id_3']))  ? $item_html_3 : '');
        $output_safe .= ((isset($args['id_3']))  ? $item_html_4 : '');
        $output_safe .= ((isset($args['id_3']))  ? $item_html_5 : '');
        $output_safe .= ((isset($args['id_3']))  ? $item_html_6 : '');
    ...
    public function textTypo(array $args)
    {
        ...
        $output_safe .= '<div class="lgx_group_field_item">';
        $output_safe .= '<div class="lgx_group_field_label">' . $args['label_size'] . '</div>';
        $output_safe .= '<input type="text" value="' . $meta_value_size . '" placeholder="' . $meta_value_size . '"  id="' . $args['id_size'] . '" class="lgx_input_width lgx_app_meta_filed lgx_app_meta_text" name="' . $args['name_size'] . '" ' . $is_pro_size . '>';
        $output_safe .= $is_pro_label_size;
        $output_safe .= '</div>'; //item 2

        $output_safe .= '<div class="lgx_group_field_item">';
        $output_safe .= '<div class="lgx_group_field_label">' . $args['label_weight'] . '</div>';
        $output_safe .= '<input type="text" value="' . $meta_value_weight . '" placeholder="' . $meta_value_weight . '"  id="' . $args['id_weight'] . '" class="lgx_input_width lgx_app_meta_filed lgx_app_meta_text" name="' . $args['name_weight'] . '" ' . $is_pro_weight . '>';
        $output_safe .= $is_pro_label_weight;
        $output_safe .= '</div>'; //item 3
    ...
    public function group2SelectText(array $args)
    {
        ...
        $output_safe .= '<div class="lgx_group_field_wrap">';
        $output_safe .= '<div class="lgx_group_field_item">';
        $output_safe .= '<div class="lgx_group_field_label">' . $args['label_select'] . '</div>';
        $options = '';
        ...
        $output_safe .= '<select name="' . $args['name_select'] . '" class="lgx_input_width lgx_app_meta_filed lgx_app_meta_select ' . (($is_pro == 'disabled') ? 'lgx_app_meta_select_disabled' : '') . '"  id="' . $args['id_select'] . '" ' . $is_multiple . '>';
        $output_safe .= $options;

        $output_safe .= '</select>';
        $output_safe .= '</div>'; //item 1
        $output_safe .= '<div class="lgx_group_field_item">';
        $output_safe .= '<div class="lgx_group_field_label">' . $args['label_text'] . '</div>';

        $output_safe .= '<input type="text" value="' . $meta_value_text . '" placeholder="' . $meta_value_text . '"  id="' . $args['id_text'] . '" class="lgx_input_width lgx_app_meta_filed lgx_app_meta_text" name="' . $args['name_text'] . '" ' . $is_pro . '>';
    ...
    array(
        'label'   => __( 'Show Brand Name', 'wp-counter-up' ),
        'desc'    => __( 'Show brand name in your showcase.', 'wp-counter-up' ),
    ...
    public function buy_pro(array $args)
    {
        ...
        $output_safe .= ((isset($args['title'])) ? '<h3 class="lgx_app_meta_buy_pro_title">' . $args['title'] . '</h3>' : '');
        $output_safe .= '<p class="lgx_input_desc lgx_app_meta_buy_pro_desc">' . $args['text'] . ' <a href="' . esc_url($args['link']) . '" target="_blank">Upgrade To Pro</a> .</p>';
        $output_safe .= '</div></td>';
        $output_safe .= '</tr>';
    ...
    public function switch(array $args)
    {
        ...
        $output_safe .= '<td>';
        $output_safe .= '<label class="lgx_switch  ' . (($is_pro == 'disabled') ? 'lgx_switch_pro' : '') . '">';
        $output_safe .= '<input type="checkbox" value="yes" id="' . $args['id'] . '" class="lgx_app_meta_filed lgx_app_meta_checkbox" name="' . $args['name'] . '" ' . $is_checked . ' ' . $is_pro . ' >';
        $output_safe .= ' <div class="lgx_switch_slider lgx_switch_round">';
        $output_safe .= '<span class="lgx_switch_on">' . $yes_label . '</span>';
        $output_safe .= '<span class="lgx_switch_off">' . $no_label . '</span>';
        $output_safe .= '</div>';
        $output_safe .= '</label>';
        $output_safe .= $is_pro_label;
        $output_safe .= '</td>';
    ...
    public function header_spacer(array $args)
    {
        ...
        $output_safe .= '<div  class="lgx_app_meta_header_spacer"><h3>' . $args['label'] . '</h3></div>';
    ...
    public function text(array $args)
    {
        ...
        $output_safe .= '<td>';
        $output_safe .= '<input type="text" value="' . $meta_value . '" placeholder="' . $meta_value . '"  id="' . $args['id'] . '" class="lgx_input_width lgx_app_meta_filed lgx_app_meta_text" name="' . $args['name'] . '" ' . $is_pro . '>';
        $output_safe .= $is_pro_label;
        $output_safe .= '</td>';
    ...
    public function number(array $args)
    {
        ...
        $output_safe .= '<td>';
        $output_safe .= '<input type="number" value="' . $meta_value . '" placeholder="' . $meta_value . '"  id="' . $args['id'] . '" class="lgx_input_width lgx_app_meta_filed lgx_app_meta_number" name="' . $args['name'] . '" ' . $is_pro . '>';
        $output_safe .= $is_pro_label;
        $output_safe .= '</td>';
    ...
    public function url(array $args)
    {
        ...
        $output_safe .= '<td>';
        $output_safe .= '<input type="url" value="' . $meta_value . '" id="' . $args['id'] . '" class="lgx_app_meta_filed lgx_app_meta_url" name="' . $args['name'] . '" ' . $is_pro . '>';
        $output_safe .= $is_pro_label;
        $output_safe .= '</td>';
    ...
    public function textarea(array $args)
    {
        ...
        $output_safe .= '<label for="' . esc_attr($args['id']) . '">';
        $output_safe .= esc_html($args['label']);
        $output_safe .= '</label></h4>';

        $output_safe .= '<p class="lgx_input_desc lgx_app_meta_desc">';
        $output_safe .= esc_html($args['desc']);
        $output_safe .= '</p>';
        ...
        $meta = get_post_meta(
            $post->ID,
            '_save_meta_lgx_counter_generator',
            true
        );

        $meta_value = (! empty($meta[$args['id']]))
            ? $meta[$args['id']]
            : $default_value;

        $output_safe .= '<td>';

        $output_safe .= '<textarea name="' . esc_attr($args['name']) . '"';
        $output_safe .= ' placeholder="' . esc_attr($args['name']) . '"';
        $output_safe .= ' class="lgx_input_width lgx_app_meta_filed lgx_app_meta_textarea"';
        $output_safe .= ' ' . esc_attr($is_pro) . '>';

        $output_safe .= esc_textarea($meta_value);
    ...
    public function select(array $args)
    {
        ...
        $output_safe .= '<select name="' . $args['name'] . '" class="lgx_input_width lgx_app_meta_filed lgx_app_meta_select ' . (($is_pro == 'disabled') ? 'lgx_app_meta_select_disabled' : '') . '"  id="' . $args['id'] . '" ' . $is_multiple . '>';
        $output_safe .= $options;
    ...
    public function color(array $args)
    {
        ...
        $output_safe .= '<td>';
        $output_safe .= '<input type="text" value="' . $meta_value . '" id="' . $args['id'] . '" class="lgx_app_meta_filed lgx_color_picker" name="' . $args['name'] . '" data-default-color="' . $meta_value . '" data-alpha-enabled="true" ' . $is_pro . '>';
        $output_safe .= $is_pro_label;
        $output_safe .= '</td>';
    ...
    public function upload(array $args)
    {
        ...
        $output_safe .= '<td>';
        $output_safe .= '<button type="button" class="button button-large lgx_icon_image_button" data-icon-field-name="' . $args['name'] . '" data-icon-img-id="' . $args['id'] . '"><i class="lgxicon lgx-icon-file-photo-o"></i> Select Icon</button>';
        $output_safe .= '&nbsp;&nbsp;&nbsp;<button type="button" class="button button-large lgx_icon_image_button_clear" data-icon-field-name="' . $args['name'] . '" data-icon-img-id="' . $args['id'] . '"><i class="lgxicon lgx-icon-remove"></i> Remove Icon</button>';
        $output_safe .= '&nbsp;&nbsp;&nbsp;<img src="" alt="" id="' . $args['id'] . '" style="width: 24px; margin-top: 5px;">';
        $output_safe .= '<input type="hidden" value="' . $meta_value . '" name="' . $args['name'] . '" ' . $is_pro . '>';
        $output_safe .= $is_pro_label;
        $output_safe .= '</td>';
